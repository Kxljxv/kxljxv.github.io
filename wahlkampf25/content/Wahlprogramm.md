...
_von Kolja Vöhringer (10.1) und Hannes Rolshoven (12)_  
_Käthe-Kollwitz-Gymnasium Berlin-Pankow_
...
- **Bessere Hygiene:**  
    Wir fordern einen dauerhaft ausreichenden und gut zugänglichen Bestand an **Periodenprodukten** und weiteren **Hygieneartikeln**. Die Ausstattung der Toiletten und deren **Sauberkeit** sollen regelmäßig mit der Schulleitung thematisiert werden. Andere Schulen haben in Sachen Vandalismus und Sauberkeit große Fortschritte gemacht. Auch unsere Schule sollte hier dringend aufholen.
...
- **Unterrichtsbelastung reduzieren:**  
    In LA sollte so **wenig wie möglich Unterricht** stattfinden, um die Anzahl an Fahrten in den Pausen gering zu halten.
    
- **Räume für die Oberstufe:**  
    Die Filiale an der Landsberger Allee soll als Raum der Oberstufe laufend **weiterentwickelt werden**. Angebote wie **Pausenraum** und **Küche** sollen noch besser ausgestattet werden (z. B. Mikrowelle).
    
- **Kapazitätsprobleme lösen:**  
    Um die Probleme bei den **Aufzügen** zu reduzieren, soll das **Treppenhaus** geöffnet werden.
...
- **Digitale Anwendungen verbessern:**  
    Wir wollen zusammen mit der Schulleitung auf eine erfolgreiche **Digitalisierung** hinarbeiten. Es bringt niemandem etwas, wenn Anwendungen wie Untis **nicht funktionieren** oder wir viele verschiedene Anmeldeportale haben und dadurch den **Überblick verlieren**.
